...
function fn_thm_setup() // Sets up variables for enabling menu themes
{
	...
	// Default theme
	fn_thm_add(THM_IDX.DFLT, fn_getText("thm_name_dflt"), fn_getText("thm_desc_dflt"), #949299, #949299, #545359, #545359, #100F11, false, spr_menu_box_dflt, spr_menu_opt_slctr_dflt, 0, spr_menu_plyrFrm_madot);
	global.thm_has[THM_IDX.DFLT] = true;
	
	
	// Madotsuki theme
	fn_thm_add(THM_IDX.MADOT, fn_getText("thm_name_madot"), fn_getText("thm_desc_madot"), #DEB2E7, #9C619C, #7B5184, #420439, #290831, true, spr_menu_box_madot, spr_menu_opt_slctr_madot, 0.25, spr_menu_plyrFrm_madot); 
...
function fn_thm_add(_THM_IDX, _name, _desc, _col_whiteLight, _col_whiteDark, _col_grayLight, _col_grayDark, _col_black, _shdw_act, _box_spr, _opt_slctr_spr, _opt_slctr_imgSpd, _plyrFrm_spr)
{
	var i = _THM_IDX;
