...
for (var z = 0; z < lvl_amtMax; z++) // opt col and optSlctr alp animation
{
	for (var i = 0; i < opt_amtMax; i++)
	{
		var _col_0 = opt_col_0[z, i]; // opt
		...
		optSlctr_alp[z, i] = lerp(optSlctr_alp[z, i], (i == opt_pos), optSlctr_alpSpd);
	}
}
