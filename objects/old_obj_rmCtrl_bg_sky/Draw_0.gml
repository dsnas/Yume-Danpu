...
for (var _x = 0; _x < sky_loop_xLen; _x++)
{
	for (var _y = 0; _y < sky_loop_yLen; _y++)
	{
		var _sky_loop_xAdd = (sky_loop_xDist * (_x - sky_loop_xLen_outRm));
		var _sky_loop_yAdd = (sky_loop_yDist * (_y - sky_loop_yLen_outRm));
