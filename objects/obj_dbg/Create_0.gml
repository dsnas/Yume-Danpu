...
global.dbg_actRm = rm_macaco; // Room the game will start at if Debug Mode is enabled (-1 == noone)

global.dbg_cmd_key = vk_alt; // Modifier key
global.dbg_cmd_rm[0] = rm_dbgwrld;
global.dbg_cmd_rm[1] = rm_macaco;

global.dbg_hud_act = false; // Determines if the drawings of Debug Mode will be drawn
