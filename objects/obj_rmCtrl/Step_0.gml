...
if (active == true)
{
	...
	for (var m = 0; m < mus_lenMax; m++)
	{
		...
		{
			mus_id[m] = fn_aud_play(mus_asset[m], mus_volType[m], mus_vol[m], , mus_pit[m], true);
		...
		{
			fn_aud_vol(mus_asset[m], mus_id[m], mus_volType[m], mus_vol[m]);
			fn_aud_pit(mus_asset[m], mus_id[m], mus_pit[m]);
		}
	}
}
