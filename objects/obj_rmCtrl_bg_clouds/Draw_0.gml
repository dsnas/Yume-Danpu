...
for (var _x = 0; _x < clouds_loop_xAmt; _x++)
{
	for (var _y = 0; _y < clouds_loop_yAmt; _y++)
	{
		var _clouds_loop_xAdd = (clouds_loop_xDist * (_x - clouds_loop_xAmt_outRm));
		var _clouds_loop_yAdd = (clouds_loop_yDist * (_y - clouds_loop_yAmt_outRm));
