...
if (lvl == LVL_MAIN) // main lvl
{
	...
	{
		fn_draw_spr(main_optImg_spr, i, (draw_x + main_optImg_x), (draw_y + main_optImg_y[i]), 1, 1, 0, opt_col_0[z, i], (main_optImg_alp * draw_alp), true);
	}
}
...
/* (old) (main lvl) chrName txt, before i made lbl
	fn_draw_txt(main_chrName_txt, (draw_x + main_chrName_x), (draw_y + main_chrName_y), 1, 1, 0, main_chrName_col[0], main_chrName_col[1], draw_alp, main_chrName_vAl, main_chrName_hAl);
*/

/* (old) (main lvl) old ccy and mny txt, before i made lbl
	ccy 	fn_draw_txt(main_ccy_txt, (draw_x + main_ccy_x), (draw_y + main_ccy_y), 1, 1, 0, main_ccy_col[0], main_ccy_col[1], draw_alp, main_ccy_vAl, main_ccy_hAl);
	mny 	fn_draw_txt(main_mny_txt, (draw_x + main_mny_x), (draw_y + main_mny_y), 1, 1, 0, main_mny_col[0], main_mny_col[1], draw_alp, main_mny_vAl, main_mny_hAl);
*/

/* (unused) (main lvl) chara portrait fade bg
for (var c = 0; c < main_chrwin_h; c++)
{
	fn_draw_px(main_chrwin_x, (main_chrwin_y + c), main_chrwin_w, 1, main_chrwin_col, main_chrwin_col, main_chrwin_col, main_chrwin_col, (draw_alp * (c / main_chrwin_h)));
}
*/
